...
const MOCK_CLINICS = [
  {
    _id:'c1', name:'SRL Diagnostics', type:'Pathology Lab', rating:4.6, reviewsCount:200,
    verified:true, open:true, tags:['24x7','Home Collection','NABL Accredited','Reports Online'],
    testsAvailable:250, homeCollection:true, homeCollectionFee:50, reportTime:'Within 6 hrs',
    distance:'1.2 km', phone:'9876543210', email:'lab@srl.com', address:'123, Health Avenue, Block C, Downtown, New York, NY 10001',
    workingHours:'7:00 AM - 9:00 PM', startingPrice:150, established:2005,
    nablNo:'NABL-CC-2021-02-00123', pathologist:'Dr. Rajesh Verma',
    ...
    description:'SRL Diagnostics is one of India\'s leading diagnostic chains, offering a comprehensive range of pathology tests with accurate results and quick turnaround times.',
    fasting:['Glucose (Fasting)','Lipid Profile','Iron Studies'],
    offers:[
      { title:'Flat 20% off on Full Body Checkup', code:'HEALTH20', desc:'Use code HEALTH20 to get 20% off on all full body checkup packages.' },
      { title:'Free Home Collection', code:'', desc:'Free home sample collection on orders above ₹499.' }
    ],
    policies:{
  ...
  {
    _id:'c2', name:'Thyrocare Technologies', type:'Diagnostic Center', rating:4.8, reviewsCount:350,
    verified:true, open:true, tags:['Home Collection','NABL Accredited','Reports Online'],
    testsAvailable:500, homeCollection:true, homeCollectionFee:0, reportTime:'Within 24 hrs',
    distance:'2.5 km', phone:'9876543211', email:'care@thyrocare.com',
    address:'456, Wellness Road, Sector 7, Los Angeles, CA 90012',
    workingHours:'6:00 AM - 10:00 PM', startingPrice:299, established:2010,
    ...
    description:'Thyrocare is a fully automated diagnostic laboratory with a focus on preventive healthcare and affordable pricing.',
  ...
  {
    _id:'c3', name:'Metropolis Healthcare', type:'Pathology Lab', rating:4.4, reviewsCount:180,
    verified:true, open:false, tags:['NABL Accredited','Reports Online'],
    testsAvailable:300, homeCollection:false, homeCollectionFee:0, reportTime:'Within 12 hrs',
    distance:'0.8 km', phone:'9876543212', email:'info@metropolis.com',
    address:'789, Market Street, Chicago, IL 60607',
    workingHours:'8:00 AM - 8:00 PM', startingPrice:199, established:2012,
    ...
    logo:'https://images.unsplash.com/photo-1585435557343-3b092031a831?w=200&h=200&fit=crop',
    description:'Metropolis Healthcare is a leading chain of diagnostic centers known for high-quality testing and experienced pathologists.',
...
const CATEGORIES = ['All', 'Blood Tests', 'Urine/Stool', 'Cardiac', 'Imaging', 'Hormone', 'Full Body Checkup', 'Allergy'];

const ALL_TESTS = [
  { id:'t1', name:'Complete Blood Count (CBC)', category:'Blood Tests', mrp:399, price:249, discount:38, reportTime:'6 hrs', homeCollection:true, rx:false, popular:true, clinicId:'c1' },
  { id:'t2', name:'Thyroid Profile (T3,T4,TSH)', category:'Hormone', mrp:699, price:449, discount:36, reportTime:'12 hrs', homeCollection:true, rx:false, popular:false, clinicId:'c1' },
  { id:'t3', name:'Lipid Profile', category:'Cardiac', mrp:599, price:349, discount:42, reportTime:'8 hrs', homeCollection:true, rx:false, popular:true, clinicId:'c1' },
  { id:'t4', name:'Blood Glucose (Fasting)', category:'Blood Tests', mrp:150, price:99, discount:34, reportTime:'4 hrs', homeCollection:true, rx:false, popular:false, clinicId:'c1' },
  { id:'t5', name:'Liver Function Test', category:'Blood Tests', mrp:799, price:499, discount:38, reportTime:'10 hrs', homeCollection:true, rx:false, popular:false, clinicId:'c1' },
  { id:'t6', name:'Kidney Function Test', category:'Blood Tests', mrp:699, price:449, discount:36, reportTime:'10 hrs', homeCollection:true, rx:false, popular:false, clinicId:'c1' },
  { id:'t7', name:'HbA1c', category:'Blood Tests', mrp:499, price:299, discount:40, reportTime:'8 hrs', homeCollection:true, rx:false, popular:false, clinicId:'c1' },
  { id:'t8', name:'Vitamin D Total', category:'Hormone', mrp:1299, price:799, discount:38, reportTime:'24 hrs', homeCollection:true, rx:false, popular:true, clinicId:'c1' },
  { id:'t9', name:'Urine Routine', category:'Urine/Stool', mrp:199, price:129, discount:35, reportTime:'6 hrs', homeCollection:true, rx:false, popular:false, clinicId:'c1' },
  { id:'t10', name:'Stool Examination', category:'Urine/Stool', mrp:299, price:199, discount:33, reportTime:'8 hrs', homeCollection:true, rx:false, popular:false, clinicId:'c1' },
  { id:'t11', name:'ECG', category:'Cardiac', mrp:399, price:249, discount:38, reportTime:'30 mins', homeCollection:false, rx:true, popular:false, clinicId:'c1' },
  { id:'t12', name:'2D Echo', category:'Cardiac', mrp:2499, price:1799, discount:28, reportTime:'1 hr', homeCollection:false, rx:true, popular:false, clinicId:'c1' },
  { id:'t13', name:'Allergy Panel (Food)', category:'Allergy', mrp:2999, price:1999, discount:33, reportTime:'48 hrs', homeCollection:true, rx:false, popular:false, clinicId:'c1' },
  { id:'t14', name:'Allergy Panel (Inhalant)', category:'Allergy', mrp:3499, price:2499, discount:29, reportTime:'48 hrs', homeCollection:true, rx:false, popular:false, clinicId:'c1' },
  { id:'t15', name:'HBsAg', category:'Blood Tests', mrp:399, price:249, discount:38, reportTime:'12 hrs', homeCollection:true, rx:false, popular:false, clinicId:'c1' },
  { id:'t16', name:'Iron Studies', category:'Blood Tests', mrp:599, price:399, discount:33, reportTime:'12 hrs', homeCollection:true, rx:false, popular:false, clinicId:'c1' },
  { id:'t17', name:'Fasting Blood Sugar', category:'Blood Tests', mrp:120, price:79, discount:34, reportTime:'4 hrs', homeCollection:true, rx:false, popular:false, clinicId:'c2' },
  { id:'t18', name:'Vitamin B12', category:'Hormone', mrp:899, price:599, discount:33, reportTime:'24 hrs', homeCollection:true, rx:false, popular:false, clinicId:'c2' },
  { id:'t19', name:'CRP Quantitative', category:'Blood Tests', mrp:499, price:349, discount:30, reportTime:'12 hrs', homeCollection:true, rx:false, popular:false, clinicId:'c2' },
  { id:'t20', name:'PSA Total', category:'Hormone', mrp:799, price:549, discount:31, reportTime:'24 hrs', homeCollection:true, rx:true, popular:false, clinicId:'c2' },
];

const PACKAGES = [
  { id:'p1', name:'Full Body Checkup (70 parameters)', price:999, mrp:1999, discount:50, includes:['CBC','Blood Sugar','Lipid Profile','Liver Function','Kidney Function','Thyroid','Vitamin D','Urine Routine'], popular:true, clinicId:'c1' },
  { id:'p2', name:'Diabetes Screening Package', price:499, mrp:899, discount:44, includes:['Fasting Blood Sugar','HbA1c','Urine Routine','Lipid Profile'], popular:false, clinicId:'c1' },
  { id:'p3', name:'Senior Citizen Package', price:1299, mrp:2499, discount:48, includes:['CBC','Lipid Profile','Kidney Function','Liver Function','Thyroid','Vitamin B12','ECG'], popular:false, clinicId:'c1' },
  { id:'p4', name:'Cardiac Risk Assessment', price:1499, mrp:2999, discount:50, includes:['Lipid Profile','ECG','2D Echo','CRP','Troponin I'], popular:true, clinicId:'c1' },
  { id:'p5', name:'Women Wellness Package', price:1799, mrp:3499, discount:49, includes:['CBC','Thyroid','Vitamin D','Iron Studies','Pap Smear'], popular:false, clinicId:'c2' },
];
...
const REVIEWS_DATA = [
  ...
  { id:'r3', user:'Amit K.', rating:5, comment:'Excellent service. The pathologist explained everything clearly.', date:'2 weeks ago' },
...
export default function PathologyClinicDetail() {
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              {test.rx && (
                <span className="inline-flex items-center gap-1 text-[10px] font-medium text-amber-600 bg-amber-500/10 px-2 py-0.5 rounded-md">
                  <Lock className="w-2.5 h-2.5" /> Prescription Required
                </span>
              )}
            </div>
            <div className="mt-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-card rounded-2xl border border-border/50 overflow-hidden shadow-sm">
                <div className="px-5 py-4 border-b border-border/30 bg-gradient-to-r from-primary/[0.04] to-transparent">
                  <h3 className="font-heading font-bold text-foreground flex items-center gap-2.5 text-base">
                    ...
                    Tests Available
                    <span className="text-sm font-normal text-muted-foreground">({clinicTests.length} tests)</span>
                  </h3>
                </div>
                <div className="p-5">
            ...
            {clinicPackages.length > 0 && (
              <SectionCard icon={Sparkles} title={`Health Packages (${clinicPackages.length})`}>
            ...
            <SectionCard icon={Clock4} title="Sample Collection Info">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="bg-gradient-to-br from-muted/40 to-muted/10 rounded-xl p-4 border border-border/40">
                  ...
                  <p className="text-sm font-semibold text-foreground">Yes — for select tests</p>
                  <p className="text-[10px] text-muted-foreground mt-1">8-12 hrs fasting needed for glucose, lipid & iron tests</p>
                </div>
                <div className="bg-gradient-to-br from-muted/40 to-muted/10 rounded-xl p-4 border border-border/40">
                  <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center mb-2">
                    <FileText className="w-4 h-4 text-primary" />
                  </div>
                  <p className="text-[10px] text-muted-foreground uppercase tracking-wider font-medium mb-0.5">Instructions</p>
                  <p className="text-sm font-semibold text-foreground">Keep ID proof ready</p>
                  <p className="text-[10px] text-muted-foreground mt-1">Lab technician will verify before sample collection</p>
                </div>
              </div>
            </SectionCard>
            ...
            {/* ═══ 12. POLICIES ═══ */}
            <SectionCard icon={ShieldCheck} title="Lab Policies">
              <div className="space-y-4">
          ...
          <div className="space-y-6">
            ...
            <SidebarCard icon={Info} title="Quick Info">
              <div className="space-y-3">
                {[
                  { icon:FlaskConical, label:'Tests Available', value:`${clinic.testsAvailable}+` },
                  { icon:Home, label:'Home Collection', value:clinic.homeCollection ? `Available ${clinic.homeCollectionFee > 0 ? `(₹${clinic.homeCollectionFee} fee)` : '(Free)'}` : 'Not Available' },
