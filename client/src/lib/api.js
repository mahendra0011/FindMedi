...
export const api = {
  ...
  // ── Pharmacy Business ───────────────────────────────────────────────────
  getPharmacyStats:      ()        => dispatch(() => Promise.resolve({ totalMedicines:0,lowStock:0,expiringSoon:0,totalOrders:0,pendingReturns:0,revenue:0 }), '/pharmacy/stats'),
  getPharmacyMedicines:  (p={})    => dispatch(() => Promise.resolve({ medicines:[] }), '/pharmacy/medicines?' + new URLSearchParams(p)),
  createPharmacyMedicine:(body)    => dispatch(() => Promise.resolve({}), '/pharmacy/medicines', { method:'POST', body: JSON.stringify(body) }),
  updatePharmacyMedicine:(id,body) => dispatch(() => Promise.resolve({}), `/pharmacy/medicines/${id}`, { method:'PUT', body: JSON.stringify(body) }),
  deletePharmacyMedicine:(id)      => dispatch(() => Promise.resolve({}), `/pharmacy/medicines/${id}`, { method:'DELETE' }),
  getPharmacyOrders:     (p={})    => dispatch(() => Promise.resolve({ orders:[] }), '/pharmacy/orders?' + new URLSearchParams(p)),
  createPharmacyOrder:   (body)    => dispatch(() => Promise.resolve({}), '/pharmacy/orders', { method:'POST', body: JSON.stringify(body) }),
  updatePharmacyOrder:   (id,body) => dispatch(() => Promise.resolve({}), `/pharmacy/orders/${id}`, { method:'PUT', body: JSON.stringify(body) }),
  deletePharmacyOrder:   (id)      => dispatch(() => Promise.resolve({}), `/pharmacy/orders/${id}`, { method:'DELETE' }),
  getPharmacyStaff:      (p={})    => dispatch(() => Promise.resolve({ staff:[] }), '/pharmacy/staff?' + new URLSearchParams(p)),
  createPharmacyStaff:   (body)    => dispatch(() => Promise.resolve({}), '/pharmacy/staff', { method:'POST', body: JSON.stringify(body) }),
  updatePharmacyStaff:   (id,body) => dispatch(() => Promise.resolve({}), `/pharmacy/staff/${id}`, { method:'PUT', body: JSON.stringify(body) }),
  deletePharmacyStaff:   (id)      => dispatch(() => Promise.resolve({}), `/pharmacy/staff/${id}`, { method:'DELETE' }),
  getPharmacyOffers:     (p={})    => dispatch(() => Promise.resolve({ offers:[] }), '/pharmacy/offers?' + new URLSearchParams(p)),
  createPharmacyOffer:   (body)    => dispatch(() => Promise.resolve({}), '/pharmacy/offers', { method:'POST', body: JSON.stringify(body) }),
  updatePharmacyOffer:   (id,body) => dispatch(() => Promise.resolve({}), `/pharmacy/offers/${id}`, { method:'PUT', body: JSON.stringify(body) }),
  deletePharmacyOffer:   (id)      => dispatch(() => Promise.resolve({}), `/pharmacy/offers/${id}`, { method:'DELETE' }),
  getPharmacyReturns:    (p={})    => dispatch(() => Promise.resolve({ returns:[] }), '/pharmacy/returns?' + new URLSearchParams(p)),
  createPharmacyReturn:  (body)    => dispatch(() => Promise.resolve({}), '/pharmacy/returns', { method:'POST', body: JSON.stringify(body) }),
  updatePharmacyReturn:  (id,body) => dispatch(() => Promise.resolve({}), `/pharmacy/returns/${id}`, { method:'PUT', body: JSON.stringify(body) }),
  getPharmacyDeliveries: (p={})    => dispatch(() => Promise.resolve({ deliveries:[] }), '/pharmacy/deliveries?' + new URLSearchParams(p)),

  // ── Lab Business ─────────────────────────────────────────────────────────
  getLabStats:           ()        => dispatch(() => Promise.resolve({ total:0,pending:0,processing:0,completed:0,critical:0 }), '/lab/stats'),
  getLabBookings:        (p={})    => dispatch(() => Promise.resolve({ bookings:[] }), '/lab/bookings?' + new URLSearchParams(p)),
  createLabBooking:      (body)    => dispatch(() => Promise.resolve({}), '/lab/bookings', { method:'POST', body: JSON.stringify(body) }),
  updateLabBooking:      (id,body) => dispatch(() => Promise.resolve({}), `/lab/bookings/${id}`, { method:'PUT', body: JSON.stringify(body) }),
  deleteLabBooking:      (id)      => dispatch(() => Promise.resolve({}), `/lab/bookings/${id}`, { method:'DELETE' }),
  getLabOrders:          (p={})    => dispatch(() => Promise.resolve({ orders:[] }), '/lab/orders?' + new URLSearchParams(p)),
  getLabTests:           ()        => dispatch(() => Promise.resolve({ tests:[] }), '/lab/tests'),
  getLabEquipment:       (p={})    => dispatch(() => Promise.resolve({ equipment:[] }), '/lab/equipment?' + new URLSearchParams(p)),
  createLabEquipment:    (body)    => dispatch(() => Promise.resolve({}), '/lab/equipment', { method:'POST', body: JSON.stringify(body) }),
  updateLabEquipment:    (id,body) => dispatch(() => Promise.resolve({}), `/lab/equipment/${id}`, { method:'PUT', body: JSON.stringify(body) }),
  deleteLabEquipment:    (id)      => dispatch(() => Promise.resolve({}), `/lab/equipment/${id}`, { method:'DELETE' }),
  getLabPackages:        (p={})    => dispatch(() => Promise.resolve({ packages:[] }), '/lab/packages?' + new URLSearchParams(p)),
  createLabPackage:      (body)    => dispatch(() => Promise.resolve({}), '/lab/packages', { method:'POST', body: JSON.stringify(body) }),
  updateLabPackage:      (id,body) => dispatch(() => Promise.resolve({}), `/lab/packages/${id}`, { method:'PUT', body: JSON.stringify(body) }),
  deleteLabPackage:      (id)      => dispatch(() => Promise.resolve({}), `/lab/packages/${id}`, { method:'DELETE' }),
};
// 2
