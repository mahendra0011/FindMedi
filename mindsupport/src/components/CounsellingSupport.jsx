    ...
    <section className="bg-[#0a0e1a] py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-300 text-xs font-medium mb-4">
            <Sparkles className="h-3.5 w-3.5" />
            Therapy & Counselling
          </div>
          <h2 className="text-3xl md:text-5xl font-bold mb-4">
            Counselling &{" "}
            <span className="text-transparent bg-gradient-to-r from-blue-400 via-violet-400 to-rose-400 bg-clip-text">
              Therapy Support
            </span>
          </h2>
