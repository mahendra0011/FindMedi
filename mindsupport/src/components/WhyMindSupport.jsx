      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-4">
            Built around <span className="text-transparent bg-gradient-to-r from-violet-400 via-purple-400 to-cyan-400 bg-clip-text">how you actually heal</span>
          </h2>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-sm text-slate-400 leading-relaxed">{reason.text}</p>
                </div>
              </div>
              <div className="mt-5 pt-4 border-t border-white/[0.06] flex items-center gap-2">
                ...
                <span className="text-xs font-medium text-slate-500 group-hover:text-slate-400 transition-colors">{reason.stats}</span>
                <div className="ml-auto opacity-0 group-hover:opacity-100 transition-opacity">
                  <svg className="h-4 w-4 text-violet-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
                </div>
              </div>
            </div>
          ))}
