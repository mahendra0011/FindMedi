...
const counsellorPhotos = {
  ...
  "Sana Qureshi": "https://images.unsplash.com/photo-1567532939604-b6b5b0db2604?w=400&h=400&fit=crop&crop=face&auto=format",
  "Dr. Arjun Sen": "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=400&h=400&fit=crop&crop=face&auto=format",
  "Meera Shah": "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400&h=400&fit=crop&crop=face&auto=format",
};
...
const seededCounsellors = [
  ...
  },
  {
    ...
    location: "Delhi NCR",
    education: "Certified relationship counselling practitioner",
    consultationModes: ["google-meet", "voice-call"],
    counsellorType: "mentor",
    verificationBadge: "Community Mentor",
    experience: "4 years",
    ...
    availability: ["Monday: 14:00-17:00", "Wednesday: 10:00-13:00", "Friday: 15:00-18:00"],
    rating: 4.7,
    reviews: 63,
    responseTime: "Within 12 hours",
  ...
  },
  {
    ...
    education: "PhD Clinical Psychology, certified in sleep therapy",
    consultationModes: ["google-meet", "in-person", "voice-call"],
    counsellorType: "professional",
    verificationBadge: "Verified Professional",
    experience: "9 years",
    ...
    availability: ["Tuesday: 15:00-18:00", "Thursday: 10:00-13:00", "Saturday: 14:00-17:00"],
    rating: 4.8,
    reviews: 119,
    responseTime: "Fast Response",
  ...
  },
  {
    ...
    education: "Certified mindfulness meditation instructor",
    consultationModes: ["google-meet", "voice-call"],
    counsellorType: "mentor",
    verificationBadge: "Community Mentor",
    experience: "7 years",
    ...
    availability: ["Monday: 11:00-14:00", "Wednesday: 16:00-19:00", "Friday: 09:00-12:00"],
    rating: 4.8,
    reviews: 91,
    responseTime: "Within 24 hours",
...
const supportPlanSeeds = {
  one: {
    supportPlanId: "one-time",
    supportPlanName: "One-Time Session",
    supportPlanDuration: "Single session",
    supportPlanCadence: "One-time consultation",
    supportPlanBestFor: ["Immediate support", "One-off guidance", "Quick check-in"],
  },
  short: {
...
function packagePricesFromSession(sessionPricing = 0, type = "professional") {
  ...
  return {
    oneTime: Math.max(299, Math.round((base * 1) / 50) * 50 - 1),
...
async function seedApprovedCounsellors() {
  ...
  for (const counsellor of seededCounsellors) {
    const userUpdate = {
      ...
      profilePhotoUrl: counsellorPhotos[counsellor.name] || seedAvatar(counsellor.name),
