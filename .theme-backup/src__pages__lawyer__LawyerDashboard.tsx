    ...
    <div className="w-full space-y-6 pb-20">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/80 dark:border-slate-800 p-5 sm:p-6 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative overflow-hidden">
        ...
        <div className="flex items-center gap-4 relative z-10">
          <div className="relative">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-600 to-violet-800 text-white flex items-center justify-center font-black text-2xl shadow-md ring-4 ring-indigo-50 dark:ring-indigo-950/40">
      ...
      {activeTab === 'overview' && (
        <div className="space-y-6">
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-700 via-indigo-800 to-slate-900 p-6 sm:p-8 text-white shadow-xl">
            <div className="absolute top-0 right-0 -mr-16 -mt-16 w-80 h-80 rounded-full bg-white/10 blur-3xl pointer-events-none" />
            <div className="absolute bottom-0 right-1/4 w-40 h-40 rounded-full bg-indigo-400/20 blur-2xl pointer-events-none" />
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="space-y-3 max-w-2xl">
                <div className="flex flex-wrap items-center gap-2">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/15 backdrop-blur-md text-xs font-bold text-indigo-100 border border-white/20">
                ...
                <div className="flex flex-wrap items-center gap-3 pt-2">
                  ...
                  <Button
                    ...
                    className="bg-white text-indigo-900 hover:bg-indigo-50 font-bold text-xs rounded-xl shadow-md h-9 px-4 gap-1.5"
                  >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-1 gap-3 shrink-0">
                <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-3.5 text-center sm:text-left min-w-[130px]">
                  <span className="text-[10px] text-indigo-200 uppercase font-bold tracking-wider block">Wallet Balance</span>
                  <span className="text-xl font-black text-white">₹{earnings?.walletBalance?.toLocaleString() || 0}</span>
                </div>
                <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-3.5 text-center sm:text-left min-w-[130px]">
                  <span className="text-[10px] text-indigo-200 uppercase font-bold tracking-wider block">Rating</span>
                ...
                <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-3.5 text-center sm:text-left min-w-[130px] col-span-2 sm:col-span-1">
                  <span className="text-[10px] text-indigo-200 uppercase font-bold tracking-wider block">Completed Cases</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <motion.div
              whileHover={{ y: -4, scale: 1.02 }}
              transition={{ type: 'spring', stiffness: 300 }}
              className="relative overflow-hidden rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 p-5 shadow-sm space-y-2 group hover:border-indigo-500/50"
            >
            ...
            <motion.div
              whileHover={{ y: -4, scale: 1.02 }}
              transition={{ type: 'spring', stiffness: 300 }}
              className="relative overflow-hidden rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 p-5 shadow-sm space-y-2 group hover:border-violet-500/50"
            >
              ...
              <div className="mt-2 text-xs text-slate-400 flex items-center justify-between pt-1 border-t border-slate-100 dark:border-slate-800">
                ...
                <span className="text-indigo-600 dark:text-indigo-400 font-bold">100% Settled</span>
              </div>
            </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  ...
                  <div className="flex items-center gap-2 self-start sm:self-auto text-xs bg-slate-100 dark:bg-slate-800 p-1.5 rounded-xl border border-slate-200 dark:border-slate-700">
                    <span className="flex items-center gap-1.5 px-2 font-semibold text-indigo-600 dark:text-indigo-400">
                          ...
                          if (active && payload && payload.length) {
                            return (
                              <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-3 shadow-xl text-xs space-y-1.5">
                                ...
                                <div className="flex items-center justify-between gap-4 text-indigo-600 font-bold">
                                  <span>Revenue:</span>
                ...
                <div className="grid grid-cols-3 gap-3 pt-3 border-t border-slate-100 dark:border-slate-800 text-xs">
                  <div>
                    ...
                    <p className="font-bold text-indigo-600 dark:text-indigo-400 text-sm mt-0.5">₹{profile?.consultationFee || 500} / session</p>
                  </div>
                  <div>
                            ...
                            if (active && payload && payload.length) {
                              return (
                                <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-2 shadow-lg text-xs">
                                  ...
                                  <p className="text-indigo-600 font-bold">{payload[0]?.value}% of consultations</p>
                                </div>
                              );
                            }
                            return null;
            ...
            {activeBooking && (
              <div className="p-6 rounded-3xl bg-gradient-to-br from-indigo-500/10 via-violet-500/5 to-cyan-500/10 border-2 border-indigo-500/30 dark:border-indigo-500/20 shadow-md space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div className="flex items-center gap-2.5">
                    <span className="w-3 h-3 rounded-full bg-emerald-500 animate-ping" />
                    <Badge className="bg-indigo-700 text-white text-[11px] uppercase font-bold tracking-wide">
                  ...
                  <div className="inline-flex items-center gap-2 bg-white dark:bg-slate-900 border border-indigo-500/20 px-3.5 py-1 rounded-2xl text-xs font-bold text-slate-800 dark:text-slate-100 shadow-sm">
                    <Clock className="w-3.5 h-3.5 text-indigo-600 animate-spin" />
                    Mode: <span className="capitalize text-indigo-600">{activeBooking.consultationMode?.replace('_', ' ')}</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-1">
                  ...
                  <div className="flex items-center gap-2 justify-start sm:justify-end self-center">
                    <Button
                      type="button"
                      onClick={() => setActiveTab('active')}
                      className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs rounded-xl shadow-sm h-10 px-5"
                    >
