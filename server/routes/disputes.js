...
router.put('/:id/status', protect, superadminOnly, validate(disputeStatusSchema), async (req, res) => {
  try {
...
router.put('/:id/assign', protect, superadminOnly, validate(disputeAssignSchema), async (req, res) => {
  try {
