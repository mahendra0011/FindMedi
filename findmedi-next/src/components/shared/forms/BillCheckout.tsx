...
import { Stethoscope, Beaker, Pill } from 'lucide-react';

export interface BillCheckoutLineItem {
  name: string;
  price?: number;
  qty?: number;
  rx?: boolean;
...
export interface BillCheckoutDetails {
  doctor?: string;
...
export interface BillCheckoutProps {
  amount: number;
  serviceType: 'appointment' | 'test' | 'medicine';
  provider?: string;
  details?: BillCheckoutDetails;
  lineItems?: BillCheckoutLineItem[];
  platformFee?: number;
  gst?: number;
