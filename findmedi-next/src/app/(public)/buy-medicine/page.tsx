/**
 * Buy medicine — store listing page — Server Component (SEO-critical).
 * Ported from client/src/pages/BuyMedicine.jsx.
 * Lists all pharmacy stores with a link to each store's medicine inventory.
 */
          ...
          <Card key={pharmacy._id} className="h-full">
            ...
            <CardContent>
              ...
              <Button className="w-full" size="sm" asChild>
                <a href={`/buy-medicine/${pharmacy._id}`}>View Store</a>
              </Button>
            </CardContent>
          </Card>
        ))}
