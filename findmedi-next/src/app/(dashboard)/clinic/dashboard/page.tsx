...
import {
  CalendarDays, Calendar, User, CheckCircle, AlertCircle, Clock, Star, Users,
  IndianRupee, TrendingUp, RotateCcw, Sparkles, ChevronRight, Quote, MessageCircle,
  ClipboardList, TestTube, FileText, Zap, Syringe, Stethoscope,
  Download, CreditCard, Smartphone, Landmark, Wallet,
  Building2, Video, Phone, MapPin, CalendarClock, CheckCircle2, X
} from 'lucide-react';
...
function getAppointmentModeMeta(appt: any) {
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3.5">
          ...
          {/* 4. Voice Calls */}
          <div
            onClick={() => router.push('/clinic/calls')}
          ...
          {/* 5. Patient Chat */}
          <div
            onClick={() => router.push('/clinic/chat')}
      ...
      <div className="grid lg:grid-cols-3 gap-6 mb-6">
                    ...
                    <div key={a._id} className="group flex flex-col sm:flex-row sm:items-center justify-between p-3.5 bg-muted/20 rounded-2xl border border-border/30 hover:bg-muted/40 hover:border-primary/20 transition-all duration-200 gap-3">
                      ...
                      <div className="flex items-center gap-2 self-end sm:self-auto shrink-0">
                        ...
                        {apptTab === 'upcoming' && (
                          <div className="flex items-center gap-2">
                            {mode.key === 'home' && (
                              <Button size="sm" variant="outline" className="text-xs h-8 rounded-xl border-violet-500/30 text-violet-600 hover:bg-violet-500/10" onClick={() => router.push('/clinic/home-visit')}>
                                <MapPin className="w-3 h-3 mr-1" /> Route Map
                              </Button>
                            )}
                            {mode.key === 'video' && (
                              <Button size="sm" variant="outline" className="text-xs h-8 rounded-xl border-cyan-500/30 text-cyan-600 hover:bg-cyan-500/10" onClick={() => router.push('/clinic/video-calls')}>
                                <Video className="w-3 h-3 mr-1" /> Video Room
                              </Button>
                            )}
                            <Button size="sm" variant="outline" className="text-xs h-8 rounded-xl" onClick={() => router.push('/clinic/appointments')}>
                              Details
                            </Button>
                          </div>
                        )}
                        {apptTab === 'today' && (
                          <div className="flex items-center gap-2">
                            ...
                            <Button size="sm" className="text-xs h-8 rounded-xl bg-primary text-primary-foreground" onClick={() => router.push('/clinic/appointments')}>
                              Start Visit
                            </Button>
                          </div>
                        )}
                        {apptTab === 'complete' && (
                          <Button size="sm" variant="outline" className="text-xs h-8 rounded-xl text-primary border-primary/20 hover:bg-primary/5" onClick={() => router.push('/clinic/prescriptions')}>
                            View Rx
                          </Button>
                        )}
                      </div>
        ...
        <div className="bg-card rounded-3xl border border-border/50 p-5 sm:p-6 shadow-sm">
          <div className="flex items-center justify-between mb-5">
            ...
            <Button variant="outline" size="sm" className="gap-1.5 rounded-xl text-primary border-primary/20 hover:bg-primary/5 hover:text-primary" onClick={() => router.push('/clinic/billing')}>
      ...
      <div className="grid lg:grid-cols-3 gap-6 mb-6">
        ...
        <div className="bg-card rounded-3xl border border-border/50 p-5 sm:p-6 shadow-sm">
          <div className="flex items-center justify-between mb-5">
            ...
            <Button variant="outline" size="sm" className="gap-1.5 rounded-xl text-cyan-500 border-cyan-500/20 hover:bg-cyan-500/5 hover:text-cyan-500" onClick={() => router.push('/clinic/schedule')}>
        ...
        <div className="bg-card rounded-3xl border border-border/50 p-5 sm:p-6 shadow-sm">
          <div className="flex items-center justify-between mb-5">
            ...
            <Button variant="outline" size="sm" className="gap-1.5 rounded-xl text-amber-500 border-amber-500/20 hover:bg-amber-500/5 hover:text-amber-500" onClick={() => router.push('/clinic/patients')}>
        ...
        <div className="bg-card rounded-3xl border border-border/50 p-5 sm:p-6 shadow-sm">
          <div className="flex items-center justify-between mb-5">
            ...
            <Button variant="outline" size="sm" className="gap-1.5 rounded-xl text-blue-500 border-blue-500/20 hover:bg-blue-500/5 hover:text-blue-500" onClick={() => router.push('/clinic/reviews')}>
              View <ChevronRight className="w-3.5 h-3.5" />
            </Button>
          </div>
          {reviews.length > 0 ? (
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }}
        ...
        <div className="flex items-center justify-between mb-5">
          ...
          <Button variant="outline" size="sm" className="gap-1.5 rounded-xl text-rose-500 border-rose-500/20 hover:bg-rose-500/5 hover:text-rose-500" onClick={() => router.push('/clinic/test-requests')}>
            View All <ChevronRight className="w-3.5 h-3.5" />
          </Button>
        </div>
