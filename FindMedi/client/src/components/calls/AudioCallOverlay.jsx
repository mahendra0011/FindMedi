...
import {
  PhoneOff, Mic, MicOff, Volume2, Volume1, VolumeX,
  Minimize2, Disc, User, ShieldCheck, Wifi, Headphones, ChevronDown,
  FileText, Save, X, Stethoscope, Phone
} from 'lucide-react';
        ...
        >
          ...
          <div className="w-full flex flex-col items-center gap-4 relative z-10 pt-4">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Audio Output Selector (Bluetooth / Wired / Speaker / Earpiece) */}
              {audioDevices.length > 0 && (
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="center" className="w-56">
                    <DropdownMenuItem onClick={() => setAudioOutput('default')}>
                      System Default
                    </DropdownMenuItem>
