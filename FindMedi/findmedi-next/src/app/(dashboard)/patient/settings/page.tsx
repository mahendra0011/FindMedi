/**
 * Platform Settings — ported from client/src/pages/patient/PatientSettings.jsx (Phase 4).
 * Notification, privacy and display preferences (local-first; persistence follows).
 */
'use client';

import { useState } from 'react';
import { Bell, Lock, Globe, Moon, Sun, Monitor, Loader2 } from 'lucide-react';
        ...
        <div className="lg:col-span-2 space-y-4">
          <SettingSection title="Notifications" icon={Bell}>
            ...
            <div className="mt-3 space-y-2">
              {['Appointment reminders', 'Lab test updates', 'Medicine delivery alerts', 'Payment receipts', 'Promotional offers'].map(
                (item) => (
          ...
          <SettingSection title="Display Preferences" icon={Monitor}>
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {[
                ...
                <button
                  key={opt.label}
                  className="px-3.5 py-2 rounded-xl text-xs font-medium bg-muted hover:bg-muted/80 border border-border/40 flex items-center gap-2"
                >
