...
>(({ className, children, side = 'left', ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ref={ref}
      className={cn(
        'fixed z-50 gap-y-3 overflow-y-auto p-6 shadow-lg bg-background',
        side === 'left' && 'inset-y-0 left-0 h-screen w-3/4 max-w-xs border-r',
        side === 'right' && 'inset-y-0 right-0 h-screen w-3/4 max-w-xs border-l',
