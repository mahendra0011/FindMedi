/**
 * Technician profile card — used on technician directory pages.
 *
 * Ported from client/src/components/TechnicianCard.jsx.
 * Migration changes:
...
export default function TechnicianCard({ technician, index = 0 }: TechnicianCardProps) {
  ...
  return (
    <motion.div
      ...
      onClick={() => navigate.push(`/technician/${techId}`)}
    >
      {/* ─── Cover ─── */}
      <div className={cn(
      ...
      <div className="px-4 pt-0 pb-4 -mt-6 flex-1 flex flex-col">
        ...
        <Button
          ...
          onClick={(e) => { e.stopPropagation(); navigate.push(`/technician/${techId}`); }}
        >
