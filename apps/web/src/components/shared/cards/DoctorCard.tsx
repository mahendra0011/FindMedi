/**
 * Doctor detail card — used on HospitalDoctors listing and dashboard.
 *
 * Ported from client/src/components/DoctorCard.jsx.
 * Migration changes:
...
/** Props for DoctorCard — uses Partial because listing data may not include all doctor fields. */
interface DoctorCardProps {
  doctor: Partial<DoctorModel> & Pick<DoctorModel, '_id'>;
  index?: number;
}
      ...
      <div className="px-4 pt-3 pb-4 space-y-3 flex-1 flex flex-col">
        ...
        <div className="flex gap-2 pt-1 mt-auto">
          ...
          <Button
            ...
            onClick={() => navigate.push(profilePath)}
          >
