...
interface HospitalConsultationHubProps {
  todayApptsCount: number;
}

export function HospitalConsultationHub({ todayApptsCount }: HospitalConsultationHubProps) {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3.5">
        ...
        >
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              In-person clinic OPD patient consultations, token queue, prescription &amp; vitals.
            </p>
          </div>
          <div className="mt-4 pt-2.5 border-t border-blue-500/20 flex items-center justify-between text-xs font-semibold text-blue-600">
            <span>{todayApptsCount} active today</span>
        ...
        >
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Live patient route tracking map, Haversine distance, urban ETA, and arrival check-in.
            </p>
          </div>
