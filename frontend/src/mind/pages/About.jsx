...
import founderImg from "@/mind/assets/profile-yes2-BIKHBByD.png";
    ...
    <div className="min-h-screen bg-background text-foreground theme-findmedi">
      ...
      <main className="pt-16">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
                <Button className="bg-gradient-primary hover:opacity-90 px-8 py-6 text-base font-bold text-white shadow-lg shadow-primary/25 glow-primary pulse-glow group" onClick={() => navigate("/mind/counselling")}>
                  Find a Counsellor
                  <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
                </Button>
                <Button variant="outline" className="border-glass-border/50 hover:bg-glass/30 backdrop-blur-sm px-8 py-6 text-base font-bold" onClick={() => navigate("/mind/resources")}>
        ...
        <section className="relative py-16 md:py-24">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              <Badge className="bg-primary/10 text-primary border border-primary/25 mb-4">How It Works</Badge>
        ...
        <section className="relative py-16 md:py-24">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              <Badge className="bg-primary/10 text-primary border border-primary/25 mb-4">
