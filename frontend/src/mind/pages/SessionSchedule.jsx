...
import { ArrowLeft, ArrowRight, CalendarCheck, Check, CheckCircle2, ClipboardList, Clock3, CreditCard, Info, Landmark, Mail, MessageCircle, Phone, ShieldCheck, Smartphone, Star, Video, Wallet } from "lucide-react";
      ...
      <main className="pt-16">
        <section className="dashboard-motion relative overflow-hidden py-10 md:py-12">
          ...
          <div className="relative mx-auto max-w-[1180px] px-4 sm:px-6 lg:px-8">
            <button
              type="button"
              onClick={() => navigate(selectedCounsellor ? `/mind/counselling/${selectedCounsellor.id}` : "/mind/counselling")}
                    ...
                    <div className="p-4 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg mb-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <Button size="sm" variant="outline" className="mt-2" onClick={() => navigate(`/mind/intake/${packageId}`)}>
                            Fill Intake Form
                          </Button>
                        </div>
                      </div>
