import { Brain, Mail, Phone, MapPin, Globe, AtSign, Camera, Briefcase } from "lucide-react";
...
const Footer = () => {
  ...
  const footerLinks = {
    Platform: [
      { name: "Wellness Dashboard", href: "/mind/wellness" },
      { name: "Resources", href: "/mind/resources" },
      { name: "Counselling", href: "/mind/counselling" },
      { name: "Peer Support", href: "/mind/peer" },
    ],
    Support: [
      { name: "Help Center", href: "/mind/resources" },
  ...
  const socialLinks = [
    ...
    { icon: Camera, href: "https://www.instagram.com", label: "Instagram" },
    { icon: Briefcase, href: "https://www.linkedin.com", label: "LinkedIn" },
  ];
