 ...
 *
 * Ported from client/src/components/ReviewDialog.jsx.
 * Migration changes:
 *   - api.createReview → request() from @/lib/api/client
...
export type EntityType = 'doctor' | 'hospital' | 'clinic' | 'lab' | 'pharmacy' | 'technician';
...
export default function ReviewDialog({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const review = await request<Review>('/reviews', { method: 'POST', body: JSON.stringify(body) });
