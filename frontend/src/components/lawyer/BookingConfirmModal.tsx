    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-150">
      <div className="relative w-full max-w-lg bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xl p-6 sm:p-7">
        ...
        {urgency === 'urgent' ? (
          ...
          <div className="mb-4 p-3 rounded-2xl bg-slate-100/60 dark:bg-white/10 border border-slate-200 dark:border-slate-700 flex items-center gap-3">
            {lawyerUser.avatar ? (
              <img
            ...
            <div className="flex-1 min-w-0">
              <div className="font-bold text-sm text-slate-900 dark:text-slate-100 flex items-center gap-1.5">
                ...
                <ShieldCheck className="w-3.5 h-3.5 text-slate-900 dark:text-slate-100" />
              </div>
        ...
        {/* Fee Breakdown */}
        <div className="mt-4 p-3.5 rounded-2xl bg-slate-100/50 dark:bg-white/10 border border-slate-200 dark:border-slate-700 flex items-center justify-between">
          <div>
