    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-150">
      <div className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xl p-6 sm:p-8 space-y-6">
          ...
          <div className="flex-1 min-w-0 pr-8">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {lawyer.isPoliceVerified && (
                <Badge className="bg-indigo-600 text-white font-bold gap-1 text-[11px] px-2 py-0.5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          ...
          <div className="p-3 rounded-2xl bg-blue-50/60 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 text-center">
            <div className="text-lg font-black text-blue-700 dark:text-blue-400">
              {lawyer.casesHandled || 0}+
            </div>
            <div className="text-[10px] font-semibold text-blue-600/80 dark:text-blue-500/80 mt-0.5 flex items-center justify-center gap-1">
          ...
          <div className="p-3 rounded-2xl bg-indigo-50/60 dark:bg-indigo-950/20 border border-indigo-200 dark:border-indigo-900 text-center">
            ...
            <div className="text-[10px] font-semibold text-indigo-600/80 dark:text-indigo-500/80 mt-0.5 flex items-center justify-center gap-1">
        ...
        <div>
          ...
          <div className="p-3 rounded-xl border border-indigo-200 dark:border-indigo-800/60 bg-indigo-50/40 dark:bg-indigo-950/20 flex items-center gap-2.5 text-xs">
